<template>
  <footer class="text-gray-700 text-sm leading-normal flex flex-wrap justify-between mx-auto max-w-3xl px-6 sm:px-12">
    <div class="w-full sm:w-1/2 mb-4 sm:mb-0">
      <p><a :href="$static.metadata.siteUrl" class="text-green-700 border-b border-transparent hover:border-green-700 transition-border-color">{{ $static.metadata.siteName }}</a> by <a href="https://github.com/sparlingo" class="text-orange-700  border-b border-transparent hover:border-orange-400 transition-border-color">Potassium Software</a></p>
